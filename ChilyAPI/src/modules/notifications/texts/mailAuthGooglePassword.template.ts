export const googleAuthUserInvalidTemplate = (email: string) => `
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
  ...
  <title>Restablecimiento de contraseña no permitido para usuarios registrados con Google en Donde Chily</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h2>Restablecimiento de contraseña no permitido para usuarios registrados con Google en Donde Chily</h2>
    </div>
    <div class="logo">
    ...
    <div class="content">
      <p>Hola ${email},</p>
      <p>El restablecimiento de contraseña no está permitido para usuarios registrados con Google en Donde Chily.</p>
      <p>Si necesitas realizar cambios en tu cuenta, por favor contáctanos directamente.</p>
    </div>
    <div class="footer">
